...
import { nflPlayerStats, type StatCategory } from "@/lib/mock-data";
      ...
      <div className="flex bg-gradient-to-b from-card to-background p-6">
        ...
        <div className="flex flex-1 flex-col justify-center">
          ...
          <div className="mt-1 flex items-center gap-2">
            <TeamBadge abbreviation={topPlayer.team} league="NFL" size="sm" />
          </div>
        </div>
      </div>
              ...
              >
                ...
                <td className="p-3">
                  ...
                  <div className="mt-1 flex items-center gap-2 text-[10px] text-muted-foreground">
                    <TeamBadge abbreviation={stat.team} league="NFL" size="sm" />
                    <span>{stat.team}</span>
                  </div>
                </td>
    ...
    <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          ...
          <div className="space-y-16">
            {[
              { title: "Passing", ids: ["pass_yds", "qbr"] },
              { title: "Rushing", ids: ["rush_yds"] },
              { title: "Defense", ids: ["tackles", "sacks", "interceptions"] },
            ].map((section) => (
              <section key={section.title}>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {section.ids.map((id) => {
                    const category = nflPlayerStats.find((s) => s.id === id);
